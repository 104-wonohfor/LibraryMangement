...
public class InfoReader extends javax.swing.JFrame {
    ...
    public InfoReader(Home home, String personIDNumber) {
        this.home = home;
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        this.setTitle("Reader Information");
    ...
    private void setInfo(String personIDNumber) {
        ...
        reader = new ReaderDAO().getReaderByIDNumber(personIDNumber);

        txtName.setText(reader.getName());
        txtDOB.setDate(Date.valueOf(reader.getDob()));
    ...
    private void initComponents() {
        ...
        PersonInfoPanel.setBackground(new java.awt.Color(13, 18, 130));
        PersonInfoPanel.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new Color(238,237,237)));
                ...
                .addGroup(PersonInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PersonInfoPanelLayout.createSequentialGroup()
                        .addGroup(PersonInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PersonInfoPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(PersonInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtCardID, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
        ...
        PasswordPanel.setBackground(new java.awt.Color(13, 18, 130));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(BackgroundPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 484, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private boolean checkFieldsAcceptable() {
        ...
        if (!txtPhoneNum.getText().equals(new ReaderDAO().getPhoneNumberByIDNumber(txtIDNumber.getText())) && new ReaderDAO().checkPhoneNumber(txtPhoneNum.getText())) {
            ...
            return false;
        } else if (!txtIDNumber.getText().equals(new ReaderDAO().getIDNumberByIDNumber(txtIDNumber.getText())) && new ReaderDAO().checkIDNumber(txtIDNumber.getText())) {
            JOptionPane.showMessageDialog(null, "Another Reader has this ID number", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void btnEditInformationActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        reader.setDob(((JTextField) txtDOB.getDateEditor().getUiComponent()).getText());
        reader.setAddress(txtAddress.getText());
        reader.setGender(txtGender.getText());
        reader.setPhoneNumber(txtPhoneNum.getText());
        reader.setEmail(txtEmail.getText());
        reader.setIdNumber(txtIDNumber.getText());
        reader.setCardID(txtCardID.getText());

        if (new ReaderDAO().editReader(reader)) {
    ...
    private void btnEditPasswordActionPerformed(java.awt.event.ActionEvent evt) {
        if (checkPasswordAcceptable()) {
            if (new ReaderDAO().editPasswordByIDNumber(txtIDNumber.getText(), hashPassword(new String(txtNewPassword.getPassword()))) == true) {
    ...
    private boolean checkPasswordAcceptable() {
        ...
        if (!hashPassword(new String(txtOldPassword.getPassword())).equals(new ReaderDAO().getPasswordByIDNumber(txtIDNumber.getText()))) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new InfoReader(new Home(), null).setVisible(true);
                } catch (Exception e) {
                    e.printStackTrace();
                }            
            }
